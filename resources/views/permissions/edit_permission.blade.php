...
<div class="container-fluid">
	    ...
	    <div class="card-body">
		    <div class="row">
		    	<div class="col-sm-12">
		    		<div class="row">
						<div class="col-sm-10 " >
							<label>إسم الصلاحيه<i class="fas fa-exclamation-circle" style="cursor: pointer;color:#FFC107" data-toggle="modal" data-target="#modal-secondary"></i></label>
	...
	<div class="modal-dialog">
		...
		<div class="modal-body">
			<p>هذه الصفحة خاصة بتعديل الصلاحية</p>
		</div>
		</div>
	</div>
	</div>
	...
	<script type="text/javascript">
		...
		$('.update_permission').on('click',function(){
	        ...
	        }else if(role === '')
	        {
			  ...
			  $.post("{{url('update-permission')}}",{_token:"{{csrf_token()}}",id:role_id,ids:ids,role:role},function(data, status){
