...
@section('content')
  ...
  <div class="card card-primary card-outline">
    ...
    <div class="card-header">
        @if(!is_null($user))
        <h5 class="m-0" style="display: inline;">تقارير المشرف <a href="{{route('eidtuser',$user->id)}}">{{$user->name}}</a> <i class="fas fa-exclamation-circle" style="cursor: pointer;color:#FFC107" data-toggle="modal" data-target="#modal-secondary"></i></h5>
      @else
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-secondary">
            <div class="modal-body">
             <p>هذه الصفحة خاصة  بالتقارير الخاصة بالمشرف</p>
            </div>
          </div>
        </div>
      </div>
