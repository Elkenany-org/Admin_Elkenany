...
<div class="card card-primary card-outline">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card-body">
					<form role="form" class="contact100-form validate-form" action="{{route('Storestocksmedicine')}}" method="POST">
					@csrf
						<div class="row">
							...
							<div class="col-sm-4 comp" style="margin-top: 10px;">
								<label style="margin-top: 10px" class="text-primary">  الاسامي التجارية <span class="text-danger">*</span></label>
							...
							<div class="col-sm-4 comp" style="margin-top: 10px;">
								<label style="margin-top: 10px" class="text-primary">  المواد الفعالة <span class="text-danger">*</span></label>
								<select name="active_id"   class="form-control ">
...
// get sub sections
$(document).on('change','.section_stocks_id', function(){
