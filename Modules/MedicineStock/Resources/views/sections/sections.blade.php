                ...
                @foreach($sections as $key => $value)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{route('medicinesubsections',$value->id)}}" class="btn btn-primary btn-sm"> الأقسام الفرعية <i class="fas fa-eye"></i></a>
                        <form action="{{route('deletemedicinesection')}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
...
{{--            </div>--}}
{{--            <div class="modal-body">--}}
{{--              <form action="{{route('Storemedicinesection')}}" method="post" enctype="multipart/form-data">--}}
{{--                    {{csrf_field()}}--}}
        ...
        <div class="modal fade" id="modal-primary">
            <div class="modal-dialog">
                <div class="modal-content bg-primary">
                    ...
                    <div class="modal-body">
                        <form action="{{route('Storemedicinesection')}}" method="post">
                            {{csrf_field()}}
                            <label>إسم القسم</label> <span class="text-danger">*</span>
        ...
        <div class="modal fade" id="modal-select">
            <div class="modal-dialog">
                <div class="modal-content bg-primary">
                    ...
                    <div class="modal-body">
                        <form action="{{route('selectmedicinesection')}}" method="post">
                            {{csrf_field()}}
                            <label>إسم القسم</label> <span class="text-danger">*</span>
                            <select name="id" class="form-control" required>
                                <option value="" disabled selected>إختيار </option>
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-info">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{route('updatemedicinesection')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-outline-light" data-dismiss="modal">إغلاق</button>            </div>
                </div>
            </div>
        </div>
