        ...
        <div class="col-sm-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h5 class="m-0" style="display: inline;"> إحصائيات بعدد إستخدام الكلمة الدلالية <span class="text-primary">{{$keyword->name}}</span> </h5>
              <a href="{{route('dataanalysiskeywords')}}" class="btn btn-primary" style="float: left;margin-right:1%">
                الكلمات الدلالية
                <i class="fas fa-list"></i>
              </a>
              <select name="date" id="date" class="form-control" style="width: 8%;float:left">
