        ...
        <div class="col-sm-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h5 class="m-0" style="display: inline;"> قائمة الأقسام الرئيسية<i class="fas fa-exclamation-circle" style="cursor: pointer;color:#FFC107" data-toggle="modal" data-target="#modal-secondary"></i></h5>
                ...
                @foreach($sections as $key => $value)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{route('subsections',$value->id)}}" class="btn btn-primary btn-sm"> الأقسام الفرعية <i class="fas fa-eye"></i></a>
                         <form action="{{route('deletepsection')}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
      ...
      <div class="modal-dialog">
        <div class="modal-content bg-primary">
          <div class="modal-header">
            <h4 class="modal-title">إضافة قسم رئيسي جديد</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <form action="{{route('storepsections')}}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
        ...
        <div class="modal fade" id="modal-select">
            <div class="modal-dialog">
                <div class="modal-content bg-primary">
                    ...
                    <div class="modal-body">
                        <form action="{{route('selectpsection')}}" method="post">
                            {{csrf_field()}}
                            <label>إسم القسم</label> <span class="text-danger">*</span>
      ...
      <div class="modal fade" id="modal-update">
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            ...
            <div class="modal-body">
                <form action="{{route('updatepsection')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    {{--warning--}}
        <div class="modal fade" id="modal-secondary">
          ...
          <div class="modal-content bg-secondary">
            <div class="modal-body">
            <p>هذه الصفحة خاصة  باضافة قسم رئيسي</p>
            </div>
          </div>
          </div>
        </div>
