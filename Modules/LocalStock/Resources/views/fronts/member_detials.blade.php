...
<title>     تفاصيل البورصة اليومية </title>
    ...
    <div class="table__body row__shadow">
        <section class="table__row row__image">
                ...
                <section class="cell__container">
                    ...
                    {{$member->LocalStockproducts->name}}
                    </span>
                </section>
...
<script>
    ...
    $(document).on('change','.to', function(){
        ...
        if (from !== '')
        {
            var link = "{{url('local-stock-detials-member',$member->id)}}" + "?from=" +$('.from').val() + "&to=" +$(this).val()
    ...
    $(document).on('change','.tom', function(){
        ...
        if (from !== '')
        {
            var link = "{{url('local-stock-detials-member',$member->id)}}" + "?from=" +$('.fromm').val() + "&to=" +$(this).val()
            window.location.href = link
        }
    });
</script>
