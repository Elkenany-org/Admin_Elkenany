            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                @foreach($sections as $key => $value)
                    <tr>
                      <td>{{$key+1}}</td>
                        <td><img alt="Avatar" class="table-avatar" src="{{asset('uploads/tenders/home/'.$value->image)}}" style="width: 50px;"></td>
                        <td>{{$value->name}}</td>
                        @if($value->selected == '1')
                            <td>مثبت</td>
                        @endif
                      ...
                      <td>
                        ...
                        <form action="{{route('deletetenderssection')}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
        ...
        <div class="modal fade" id="modal-select">
            <div class="modal-dialog">
                <div class="modal-content bg-primary">
                    ...
                    <div class="modal-body">
                        <form action="{{route('selecttenderSections')}}" method="post">
                            {{csrf_field()}}
        ...
        <div class="modal fade" id="modal-primary">
            <div class="modal-dialog">
                <div class="modal-content bg-primary">
                    ...
                    <div class="modal-body">
                        <form action="{{route('storetenderSections')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
        ...
        <div class="modal fade" id="modal-update">
            <div class="modal-dialog">
                <div class="modal-content bg-info">
                    ...
                    <div class="modal-body">
                        <form action="{{route('updatetenderSections')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
...
@section('script')
    <script type="text/javascript">
        ...
        $('.edit').on('click',function(){
            ...
            var url =  '{{ url("uploads/tenders/home") }}/' + image
            $('.test').attr('src',url);
