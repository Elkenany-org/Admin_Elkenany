        ...
        <div class="col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h5 class="m-0" style="display: inline;">قائمة اقسام الوظائف  <i class="fas fa-exclamation-circle" style="cursor: pointer;color:#FFC107" data-toggle="modal" data-target="#modal-secondary"></i></h5>
                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        @foreach($categories as $key => $value)
                            <tr >
                                ...
                                <td>
                                    <a href="{{route('editCategory',$value->id)}}" class="btn btn-primary btn-sm " type="submit">  تعديل <i class="fas fa-edit"></i></a>
