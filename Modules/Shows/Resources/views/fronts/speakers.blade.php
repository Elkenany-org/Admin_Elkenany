...
<article class="partners slider my-4 mt-5">
  ...
  <div class="page__tabs container">
        <ul class="tabs__list">
            ...
            <li class="list__item list__item-4">
                <a class="list__link active" href="{{ route('front_one_show_speakers',$show->id) }}">المتحدثون</a>
            </li>
        </ul>
    </div>
    <!-- page tabs -->
    <article class="global__container container">
        <div class="row">
            @foreach($show->Speakers as $value)
            <div class="col-6 col-md-4 col-lg-3">
                    <div class="person__card">
                        <div class="person__image">
                            <img alt="" class="image" src="{{asset('uploads/show/speaker/'.$value->image)}}">
                        </div>
                        <div class="person__card__body">
                            <div class="name">{{$value->name}} </div>
                            <div class="role">{{$value->type}}</div>
