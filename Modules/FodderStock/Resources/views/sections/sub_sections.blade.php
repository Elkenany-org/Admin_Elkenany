              ...
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                @foreach($sections as $key => $value)
                    <tr>
                      ...
                      <td> 
                      <form action="{{route('subfodnumsort')}}" class="sort{{$value->id}}" method="post" style="display: inline-block;">
                          {{csrf_field()}}
                      ...
                      <td>
                        ...
                        <form action="{{route('deletefoddersubsection')}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
                            <input type="hidden" name="id" value="{{$value->id}}">
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
              <form action="{{route('storefoddersubsection')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
      ...
      <div class="modal fade" id="modal-update">
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            ...
            <div class="modal-body">
              <form action="{{route('updatefoddersubsection')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
