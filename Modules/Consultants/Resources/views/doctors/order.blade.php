        ...
        <div class="col-sm-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h5 class="m-0" style="display: inline;">قائمة الطلبات <span class="text-primary"> {{$doctor->name}} </span><i class="fas fa-exclamation-circle" style="cursor: pointer;color:#FFC107" data-toggle="modal" data-target="#modal-secondary"></i></h5>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                @foreach($doctor->DoctorOrders as $key => $value)
                    <tr>
                      <td>{{$key+1}}</td>
        ...
        {{--warning--}}
          <div class="modal fade" id="modal-secondary">
            ...
            <div class="modal-content bg-secondary">
              ...
              <p>هذه الصفحة خاصة  بقائمة الطلبات للاستشاري</p>
              </div>
            </div>
            </div>
          </div>
