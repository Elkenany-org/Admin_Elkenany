        ...
        <div class="col-sm-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h5 class="m-0" style="display: inline;">قائمة الاقسام <i class="fas fa-exclamation-circle" style="cursor: pointer;color:#FFC107" data-toggle="modal" data-target="#modal-secondary"></i></h5>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                @foreach($sections as $key => $value)
                    <tr>
                      <td>{{$key+1}}</td>   
	                    <td style="padding-top: 10px"><img alt="Avatar" class="table-avatar" src="{{asset('uploads/sections/avatar/'.$value->image)}}" style="display: inline;width: 2.5rem;"></td>
                      <td>{{$value->name}}</td>  
                      ...
                      <td>
                        ...
                        <form action="{{route('Deletesectionwafer')}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
        ...
        <div class="modal fade" id="modal-secondary">
          <div class="modal-dialog">
            <div class="modal-content bg-secondary">
              ...
              <p>هذه الصفحة خاصة   بالاقسام الخاصة بوافر</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
              <form action="{{route('Storesectionwafer')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <label>إسم القسم</label> <span class="text-danger">*</span>
                    <input type="text" name="name" class="form-control" placeholder="إسم القسم " required="" style="margin-bottom: 10px"></br>
      ...
      <div class="modal fade" id="modal-update">
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            ...
            <div class="modal-body">
              <form action="{{route('Updatesectionwafer')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
