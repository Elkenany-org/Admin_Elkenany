                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-header">
                            <h6 class="m-0" style="display: inline;">تعديل الخبر <span class="text-primary"> {{$news->title}} </span></h6>
                        </div>
                        <div class="card-body">
                            <form action="{{route('Updatenews')}}" method="post" enctype="multipart/form-data" novalidate>
                                <div class="row">
                                    {{csrf_field()}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 offset-2" style="margin-top: 10px">
                                                <div class="from-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control" value="{{$news->title}}" placeholder="عنوان الخبر" required="">
                                                </div>
                                            </div>
                                            {{-- sections --}}
                                            <div class="col-sm-8 offset-2" style="margin-top: 10px">
                                                <div class="from-group">
                                                    ...
                                                    <select name="section_id" class="form-control section_id" required>
                                                        ...
                                                        @foreach($sections as $value)
                                                            <option value="{{$value->id}}"{{ isset($news) && $news->section_id == $value->id ? 'selected'  :'' }}>{{$value->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 offset-2" style="margin-top: 10px">
                                                <div class="from-group">
                                                    <label class="text-primary">meta-description: <span class="text-danger">*</span></label>
                                                    <input type="text" name="meta" class="form-control" value="{{$news->meta}}"  placeholder="meta description" required="">
                                                </div>
                                            </div>
