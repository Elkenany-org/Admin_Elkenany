                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        >  تعديل <i class="fas fa-eye"></i></a>
                         <form action="{{route('deleteMagazinessection')}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
              <form action="{{route('storeMagazinessections')}}" method="post">
                  {{csrf_field()}}
        ...
        <div class="modal fade" id="modal-select">
            <div class="modal-dialog">
                <div class="modal-content bg-primary">
                    ...
                    <div class="modal-body">
                        <form action="{{route('selectmagazinesection')}}" method="post">
                            {{csrf_field()}}
                            <label>إسم القسم</label> <span class="text-danger">*</span>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('updateMagazinessection')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
