              ...
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                @foreach($sections as $key => $value)
                    <tr>
                      ...
                      <td> 
                        <form action="{{route('guidesubnumsort')}}" class="sort{{$value->id}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
                      ...
                      <td>
                        ...
                        >  تعديل <i class="fas fa-edit"></i></a>
                          <a href="{{route('guidecomps',$value->id)}}" class="btn btn-primary btn-sm">  الشركات <i class="fas fa-eye"></i></a>
                        <form action="{{route('deleteguidesubsection')}}" method="post" style="display: inline-block;">
                            {{csrf_field()}}
                            <input type="hidden" name="id" value="{{$value->id}}">
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
              <form action="{{route('storeguidesubsection')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
      ...
      <div class="modal fade" id="modal-update">
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            ...
            <div class="modal-body">
              <form action="{{route('updateguidesubsection')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
