...
<div class="card-body">
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="card-body">
				<form action="{{route('Updatetv')}}" method="post" enctype="multipart/form-data" novalidate>
					<div class="row">
						{{csrf_field()}}
              ...
              <div class="col-sm-8 offset-2" style="margin-top: 10px">
								<div class="from-group">
									...
									<input type="text" name="link" class="form-control" value="{{$news->link}}" placeholder="رابط التقرير" required="">
								</div>
							</div>
