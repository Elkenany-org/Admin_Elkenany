...
<div class="card-body">
	<div class="row">
		<div class="col-sm-12">
			...
			<h6 class="m-0" style="display: inline;">تعديل التحليل الفني <span class="text-primary"> {{$news->title}} </span></h6>
			</div>
			<div class="card-body">
				<form action="{{route('Updateanalysistec')}}" method="post" enctype="multipart/form-data" novalidate>
					<div class="row">
						{{csrf_field()}}
						...
						<div class="row">
							...
							<div class="col-sm-8 offset-2" style="margin-top: 10px">
								<div class="from-group">
									...
									<input type="text" name="title" class="form-control" value="{{$news->title}}" placeholder="عنوان التحليل" required="">
								</div>
							</div>
