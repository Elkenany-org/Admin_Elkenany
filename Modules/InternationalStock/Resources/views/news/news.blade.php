		...
		<div class="col-sm-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              <a href="{{route('Addlatestnews')}}" class="btn btn-primary" style="float: left;">
                     إضافة خبر  جديد 
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                @foreach($news as $key => $value)
                    ...
                    <td>
		                <a href="{{route('Editlatestnews',$value->id)}}" class="btn btn-primary btn-sm " type="submit">  تعديل <i class="fas fa-edit"></i></a>
	                  	<form action="{{route('Deletelatestnews')}}" method="post" style="display: inline-block;">
	                  		{{csrf_field()}}
