...
<!-- Start Header -->
  ...
  <div class="breadcrumb__container nt-0 container">
        <div class="custom__breadcrumb">
            <h1 class="page__title">الاخبار</h1>
        </div>
    </div>
    <!-- End breadcrumb -->
        ...
        <form class="box-tabs">
            ...
            <section class="tabs tabs-1">
                ...
                <select name="sort" onChange="window.location.href=this.value">
                    <option value="{{ route('front_section_latest_news') }}" {{ isset($sort) && $sort == "0" ? 'selected'  :'' }}> الابجدي</option>
                    <option value="{{ route('front_section_news_latest_view') }}"{{ isset($sort) && $sort == "1" ? 'selected'  :'' }}> َالاكثر تداولا</option>
                        ...
                        <div class="product__card  regular__hover">
                            ...
                            <div class="product__content">
                                <header class="product__title">
                                    <a href="{{ route('front_latest_one_news',$value->id) }}">
                                    {{$value->title}}
                                    </a>
                                </header>
